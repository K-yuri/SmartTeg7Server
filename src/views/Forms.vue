<template>
  <div>
    <h3 class="text-gray-700 text-3xl font-semibold">관리자용</h3>

    <div class="mt-4">
      <h4 class="text-gray-600">회원 정보 생성</h4>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">ID/PS</h4>
